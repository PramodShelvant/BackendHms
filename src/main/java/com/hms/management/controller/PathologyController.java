...
public class PathologyController {
	...
	@CrossOrigin
	@RequestMapping(value = "/gettestnames{testName}",method = RequestMethod.GET,produces = "application/json")
	public List<Pathology>  getByTestName(@PathVariable String testName){
		return pathologyServiceImpl.getByTestName(testName);
