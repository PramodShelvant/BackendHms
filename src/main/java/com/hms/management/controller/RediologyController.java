...
public class RediologyController {
	...
	@CrossOrigin
	@RequestMapping(value = "getbytestname",method = RequestMethod.GET,produces = "application/json")
	public List<Rediology>  getByTestName(@PathVariable String testName){
		return rediologyServiceImpl.getByName(testName);
