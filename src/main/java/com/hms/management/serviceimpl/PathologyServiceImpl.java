...
public class PathologyServiceImpl implements PathologyService{
	...
	public Pathology addPathology(Pathology pathology) throws RecordNotFoundException {
		...
		pathology.setPathologyId("PTLOGY-"+DateTimeFormatter.ofPattern("yyyyMMddhhmmss").format(LocalDateTime.now()));
	...
	public List<Pathology> getByTestName(String testName) {
 		return pathologyRepository.findByTestName(testName);
	}
}
